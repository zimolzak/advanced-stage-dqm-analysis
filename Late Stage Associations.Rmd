...
reviewed_all %>% 
  mutate(signal_type = case_when(
    signal_type == "imaging in general (should already be covered in dropdown list)" ~ "Imaging",
  ...
  arrange(desc(site), desc(cancer_type), desc(n)) %>% 
  kable()
```
