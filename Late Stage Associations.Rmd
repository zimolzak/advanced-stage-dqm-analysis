...
reviewed_all <- bind_rows(
  ...
  mutate(
    ...
    MOD_delay_pattern = as.factor(case_when(
      signal_present=="Yes" & MOD_delay_completing=="Yes" & MOD_delay_requesting=="Yes" ~ "Both",
      ...
      MOD_definite & signal_present=="Yes" ~ "Unspecified delay",
...
t1t2_ordering <- tribble(
  ...
  "    +S Pattern Both", "    Delay initiating and completing workup",
  "    +S Pattern Unspecified delay", "    Delay, unspecified",
...
reviewed_all %>% 
  ...
  mutate(
    signal_type = case_when(  # Compare to lines 233, "decode".
      ...
      is.na(signal_type) ~ "Other: misc.",  # Fold the rare NA values into Other.
      str_like(signal_other_text, "%pain%") ~ "Other: pain",
      str_like(signal_other_text, "%ida%") ~ "Iron deficiency anemia",  # merge
      str_like(signal_other_text, "%dec hb%") ~ "Other: anemia, unspecified",
      str_like(signal_other_text, "%anemia%") ~ "Other: anemia, unspecified",
      ...
      str_like(signal_other_text, "%diarrh%") ~ "Other: bowel habits",
      str_like(signal_other_text, "%cologuard%") ~ "Fecal occult blood test finding",  # merge
      str_like(signal_other_text, "%habit%") ~ "Other: bowel habits",
      str_like(signal_other_text, "%constip%") ~ "Other: bowel habits",
      str_like(signal_other_text, "%leakage%") ~ "Other: bowel habits",
      str_like(signal_other_text, "%polyp%") ~ "Colonoscopy finding",  # merge
      signal_type == "Other" ~ "Other: misc.",
