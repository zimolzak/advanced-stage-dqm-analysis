...
```{r age-definitive, warning=FALSE}
...
## TABLE 3? Race and sex vs.\ advanced

Might be useful if it helps explain what's going on and why I say mentioned only 2 levels of race as a factor in the text.
...
```{r init-completion-corr-plots, message=FALSE, warning=FALSE}
reviewed_all %>% 
  filter(signal_present=="Yes", MOD_definite) %>% 
